...
public class herenciaar extends Driver {
    public static Logger log = LogManager.getLogger(herenciaar.class);
    ...
    public void loginCheck() {
        try {
            visit(getProperty("herenciaar_VTEX"));
    ...
    public void searchBoxItems() {
        ...
        try {
            ...
            VtexPage_admitOne.getListInSearchBox(VtexPage_Umbroar.searchResultUmbroar, VtexPage_Umbroar.searchResultCountUmbroar);
