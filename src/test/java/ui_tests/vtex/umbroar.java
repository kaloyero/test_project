...
public class umbroar extends Driver {
...
//
//        try {
//            visit(getProperty("umbroar_VTEX"));
//        } catch (Exception e) {
//            e.printStackTrace();
...
//    }
    ...
    public void deleteProductFrmCart() {
        ...
        try {
            ...
            VtexPage_Umbroar.SearchProduct("remera");
            VtexPage_Umbroar.cartCheckOut();
            VtexPage_babyCotton.deleteItemCart(VtexPage_babyCotton.emptyCartMsg,VtexPage_babyCotton.umbroCartPgLogo);
            VtexPage_Umbroar.SearchProduct("remera");
            VtexPage_Umbroar.cartCheckOut();
            VtexPage_babyCotton.deleteItemCart(VtexPage_babyCotton.emptyCartMsg,VtexPage_babyCotton.umbroCartPgLogo);
