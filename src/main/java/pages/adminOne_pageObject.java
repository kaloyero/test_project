...
public class adminOne_pageObject extends Driver {

    public static int count;
    public static String UiProductName, UiProductPrice;
    public static Logger log = LogManager.getLogger(adminOne_pageObject.class);
    ...
    public adminOne_pageObject(WebDriver driver) {
